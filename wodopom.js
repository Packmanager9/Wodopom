...
window.addEventListener('DOMContentLoaded', (event) => {
                                ...
                                if (vessel.weapons[vessel.wepDrawCount].real == 1) {
                                    if (!(vessel.weapons[vessel.wepDrawCount].temp > -1)) {
                                        ...
                                        if (vessel.weapons[vessel.wepDrawCount].type == 0) {
                                            ...
                                            canvas_context.drawImage(mirror, 0, 0, hook1.width, hook1.height, this.x + (this.width * 1), this.y, this.width * .5, this.height * .5)
                                        } else if (vessel.weapons[vessel.wepDrawCount].type == 35) {
                                            canvas_context.drawImage(mirror2, 0, 0, hook1.width, hook1.height, this.x + (this.width * 1), this.y, this.width * .5, this.height * .5)
                                        }
                                    }
                                    ...
                                    if (vessel.weapons[vessel.wepDrawCount].real == 1) {
                                        if (!(vessel.weapons[vessel.wepDrawCount].temp > -1)) {
                                            ...
                                            if (vessel.weapons[vessel.wepDrawCount].type == 0) {
                                                ...
                                                canvas_context.drawImage(mirror, 0, 0, hook1.width, hook1.height, this.x + (this.width * 1), this.y + (this.width * .5), this.width * .5, this.height * .5)
                                            } else if (vessel.weapons[vessel.wepDrawCount].type == 35) {
                                                canvas_context.drawImage(mirror2, 0, 0, hook1.width, hook1.height, this.x + (this.width * 1), this.y + (this.width * .5), this.width * .5, this.height * .5)
                                            }
                                        }
                                    }
                                ...
                                if (enemy.weapons[enemy.wepDrawCount].real == 1) {
                                    if (!(enemy.weapons[enemy.wepDrawCount].temp > -1)) {
                                        ...
                                        if (enemy.weapons[enemy.wepDrawCount].type == 0) {
                                            ...
                                            canvas_context.drawImage(mirrorr, 0, 0, hookr3.width, hookr3.height, this.x - (this.width * .5), this.y, this.width * .5, this.height * .5)
                                        } else if (enemy.weapons[enemy.wepDrawCount].type == 35) {
                                            canvas_context.drawImage(mirrorr2, 0, 0, hookr3.width, hookr3.height, this.x - (this.width * .5), this.y, this.width * .5, this.height * .5)
                                        }
                                    }
                                }
                                enemy.wepDrawCount++
                                    ...
                                    if (enemy.weapons[enemy.wepDrawCount].real == 1) {
                                        if (!(enemy.weapons[enemy.wepDrawCount].temp > -1)) {
                                            ...
                                            if (enemy.weapons[enemy.wepDrawCount].type == 0) {
                                                ...
                                                canvas_context.drawImage(mirrorr, 0, 0, mirrorr.width, hookr3.height, this.x - (this.width * .5), this.y + (this.width * .5), this.width * .5, this.height * .5)
                                            } else if (enemy.weapons[enemy.wepDrawCount].type == 35) {
                                                canvas_context.drawImage(mirrorr2, 0, 0, mirrorr.width, hookr3.height, this.x - (this.width * .5), this.y + (this.width * .5), this.width * .5, this.height * .5)
                                            }
                                        }
                                    }
        ...
        shrink(t) {
            ...
            if (vessel.weapons.includes(this)) {
                if (this.bullets[t].life <= 1 || this.bullets[t].goTo.isPointInside(this.bullets[t])) {
                    ...
                    for(let g = 0;g<enemy.guys.length;g++){
                        console.log(this.bullets[t].goTo.t, this.bullets[t].goTo.k, enemy.guys[g].tile.t, enemy.guys[g].tile.k)
                        ...
                        for (let w = 0; w < enemy.weapons.length; w++) {
                            if (enemy.weapons[w].bullets.length > 0) {
                                ...
                                for (let f = 0; f < enemy.weapons[w].bullets.length; f++) {
                                    if (enemy.weapons[w].bullets[f].aura != 1) {
                        ...
                        for (let w = 0; w < vessel.weapons.length; w++) {
                            if (vessel.weapons[w].bullets.length > 0) {
                                ...
                                for (let f = 0; f < vessel.weapons[w].bullets.length; f++) {
                                    if (vessel.weapons[w].bullets[f].aura != 1) {
        ...
        draw() {
            ...
            if (vverts.includes(vessel.doors.indexOf(this))) {
                if (this.body.color == "#00ff00") {
                    ...
                    rect.draw()
                    let rect2 = new RectangleR(this.body.x - 2, this.body.y + ((this.count * 8.5) - 4), 4, 4, this.body.color)
                    rect2.draw()
                    this.link = new LineOP(rect, rect2)
                } else {
                    let rect = new RectangleR(this.body.x - 2, this.body.y - (this.count * 8.5), 4, 16 * this.count, this.body.color)
                    rect.draw()
                }
            } else {
                if (this.body.color == "#00ff00") {
                    let rect = new RectangleR(this.body.x - (this.count * 8.5), this.body.y - 2, 4, 4, this.body.color)
                    rect.draw()
                    let rect2 = new RectangleR(this.body.x + ((this.count * 8.5) - 4), this.body.y - 2, 4, 4, this.body.color)
                    rect2.draw()
                    this.link = new LineOP(rect, rect2)
                } else {
                    let rect = new RectangleR(this.body.x - (this.count * 8.5), this.body.y - 2, 16 * this.count, 4, this.body.color)
                    rect.draw()
                }
    ...
    class Ship {
        constructor(type, width, height, posx, posy, gridPoints,) {
            ...
            if (this.type == 1 || this.type == 2 || this.type == 3 || this.type == 4 || this.type == 5 || this.type == 6 || this.type == 7 || this.type == 8 || this.type == 9 || this.type == 10 || this.type == 11) {
                this.supratiles.sort((a, b) => a.y > b.y ? 1 : -1)
                this.supratiles.sort((a, b) => a.x > b.x ? -1 : 1)
        ...
        draw() {
            ...
            if (this.first == 0) {
                ...
                if (this.level < 7) {
                    ...
                    this.weapons.push(wep4)
                    if (Math.random() < .05) {
                        // let wep5 = new Weapon(Math.floor(Math.random() * 36))
                ...
                if (typeof this.spread == "undefined") {
                    ...
                    if (mode == 1) {
                        ...
                        if (this.wegflag < Math.min((this.level + 15) / 500, .125)) {
                            ...
                            if (index > -1) {
                                vessel.weapons[index] = (new Weapon(Math.floor(Math.random() * 36)))
                            } else {
                                // this.wegflag = 1
                                ...
                                if (index > -1) {
                                    vessel.upgradeMenu.wepsto[index] = (new Weapon(Math.floor(Math.random() * 36)))
                                } else {
                                    this.wegflag = 1
                                }
    ...
    class Star {
        constructor(x, y, shop = 0) {
            ...
            if (mode == 1) {
                ...
                this.body = new Circle(x * 20, (y - 360) * 20, 50, "white")
                this.spot = new Polygon(x * 20, ((y - 360) * 20), 6, getRandomLightColor(), 4 + (Math.random() * 10), (Math.random() * 2) + .2, (Math.random() * 2) + .2)
                this.link = new LineOP(this.body, this.body)
            }
            this.weapons = []
            if (Math.random() < .12) {
                ...
                for (let t = 0; t < 1; t++) {
                    this.weapons.push(new Weapon(Math.floor(Math.random() * 36)))
                }
                for (let t = 0; t < 12; t++) {
